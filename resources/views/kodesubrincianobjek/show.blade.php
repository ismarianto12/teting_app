            ...
            <div class="card-body">
                <div class="form-row form-inline">
                    <div class="col-md-12">
                        ...
                        <div class="form-group m-0">
                            <label class="col-form-label s-12 col-md-2"><strong>Rek. Objek :</strong></label>
                        ...
                        <div class="form-group m-0">
                            <label class="col-form-label s-12 col-md-2"><strong>Kode Rek. Sub Rincian Obj :</strong></label>
                            <label class="r-0 s-12 col-md-8 tl">{{ $tmrekening_akun_kelompok_jenis_objek_rincian_sub->kd_rek_rincian_objek_sub }}</label>
                        </div>
                        <div class="form-group m-0">
                            <label class="col-form-label s-12 col-md-2 pl-0"><strong>Nama Rek. Sub Rincian Obj :</strong></label>
                            <label class="r-0 s-12 col-md-8 tl">{{ $tmrekening_akun_kelompok_jenis_objek_rincian_sub->nm_rek_rincian_objek_sub }}</label>
                        </div>
                    </div>
                </div>
            </div>
