...
<div class="page bg-light">
    ...
    <div class="container-fluid my-3">
        ...
        <form class="needs-validation" id="form" method="POST" novalidate>
            ...
            <div class="card mt-2">
                <div class="card-body">
                    <input type="hidden" id="id" name="id" value="{{ $tmrekening_akun_kelompok_jenis_objek_rincian->id }}"/>
                    <div class="form-row form-inline">
                        <div class="col-md-12">
                          
                            <div class="form-group m-0">
                                <label for="kd_rek_rincian_obj" class="col-form-label s-12 col-md-2 pl-0"><strong>Kode Rek. Rincian Obj <span class="text-danger ml-1">*</span> :</strong></label>
                                <input type="text" name="kd_rek_rincian_obj" id="kd_rek_rincian_obj" placeholder="" class="form-control r-0 s-12 col-md-5" value="{{ $tmrekening_akun_kelompok_jenis_objek_rincian->kd_rek_rincian_obj }}" autocomplete="off" required/>
                            </div>
                            <div class="form-group m-0">
                                <label for="nm_rek_rincian_obj" class="col-form-label s-12 col-md-2 pl-0"><strong>Nama Rek. Rincian Obj <span class="text-danger ml-1">*</span> :</strong></label>
                                <input type="text" name="nm_rek_rincian_obj" id="nm_rek_rincian_obj" placeholder="" class="form-control r-0 s-12 col-md-5" value="{{ $tmrekening_akun_kelompok_jenis_objek_rincian->nm_rek_rincian_obj }}" autocomplete="off" required/>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-group m-0">
                                ...
                                <div class="col-md-8 p-0 mb-2">
                                    <select name="sikd_rek_akrual_id" id="sikd_rek_akrual_id" placeholder="" class="form-control r-0 s-12 select2">
                                        ...
                                        <option value="{{ $rekAkrual->id }}"@if($tmrekening_akun_kelompok_jenis_objek_rincian->sikd_rek_akrual_id == $rekAkrual->id) selected="selected"@endif>{{ '['.$rekAkrual->kd_rek_rincian_obj.'] '.$rekAkrual->nm_rek_rincian_obj }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group m-0">
                                ...
                                <div class="col-md-8 p-0 mb-2">
                                    <select name="sikd_rek_aset_id" id="sikd_rek_aset_id" placeholder="" class="form-control r-0 s-12 select2">
                                        ...
                                        <option value="{{ $rekAset->id }}"@if($tmrekening_akun_kelompok_jenis_objek_rincian->sikd_rek_aset_id == $rekAset->id) selected="selected"@endif>{{ '['.$rekAset->kd_rek_rincian_obj.'] '.$rekAset->nm_rek_rincian_obj }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-0">
                                ...
                                <div class="col-md-8 p-0 mb-2">
                                    <select name="tmsikd_rekening_lra_id" id="tmsikd_rekening_lra_id" placeholder="" class="form-control r-0 s-12 select2">
                                        ...
                                        <option value="{{ $tmsikd_rekening_lra->id }}"@if($tmrekening_akun_kelompok_jenis_objek_rincian->tmsikd_rekening_lra_id == $tmsikd_rekening_lra->id) selected="selected"@endif>{{ '['.$tmsikd_rekening_lra->kd_rek_lra.'] '.$tmsikd_rekening_lra->nm_rek_lra }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group m-0">
                                ...
                                <div class="col-md-8 p-0 mb-2">
                                    <select name="tmsikd_rekening_lak_id" id="tmsikd_rekening_lak_id" placeholder="" class="form-control r-0 s-12 select2">
                                        ...
                                        <option value="{{ $tmsikd_rekening_lak->id }}"@if($tmrekening_akun_kelompok_jenis_objek_rincian->tmsikd_rekening_lak_id == $tmsikd_rekening_lak->id) selected="selected"@endif>{{ '['.$tmsikd_rekening_lak->kd_rek_lak.'] '.$tmsikd_rekening_lak->nm_rek_lak }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group m-0">
                                ...
                                <div class="col-md-8 p-0 mb-2">
                                    <select name="tmsikd_rekening_neraca_id" id="tmsikd_rekening_neraca_id" placeholder="" class="form-control r-0 s-12 select2">
                                        ...
                                        <option value="{{ $tmsikd_rekening_neraca_id->id }}"@if($tmrekening_akun_kelompok_jenis_objek_rincian->tmsikd_rekening_neraca_id == $tmsikd_rekening_neraca_id->id) selected="selected"@endif>{{ '['.$tmsikd_rekening_neraca_id->kd_rek_neraca.'] '.$tmsikd_rekening_neraca_id->nm_rek_neraca }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
