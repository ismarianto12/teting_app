...
<body class="login">
             ...
             <form action="{{ route('register') }}" method="POST" class="form-horizontal"> 
                ...
                <div class="login-form">
                    ...
                    <div class="form-group form-action-d-flex mb-3">
                        <button type="submit" name="login" class="btn btn-secondary col-md-5 float-right mt-3 mt-sm-0 fw-bold">DAFTAR</a>
                    </div>
    ...
    <script src="{{ asset('public//assets/template/') }}/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>
