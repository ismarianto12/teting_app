        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group form-show-validation row">
                      <h1>Maaf Saat ini server sedang error , Silahkan hubungi administrator untuk perbaikan .</h1>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp64\www\edi_test\resources\views/errors/500.blade.php ENDPATH**/ ?>